<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuJS.aspx.cs" Inherits="webpruebas.menuJS" %>
...
<head runat="server">
    ...
    <title>Menu Jefe Superior</title>
                         ...
                         <table align="center">
                            <th>
                                <ul>
                                    ...
                                    <li>
                                        <a href="consultarFunci.aspx">Consultar Funcionario</a>
                                    </li>
                                    <li>
                                        <a href="resolucionesGenerales.aspx">Resoluciones Mensuales</a>
                                    </li>
                                </ul>
                            </th>
                        </table>
