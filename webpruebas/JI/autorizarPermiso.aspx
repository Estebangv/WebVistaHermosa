<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="autorizarPermiso.aspx.cs" Inherits="webpruebas.JI.autorizarPermiso" %>
    ...
    <form id="form1" runat="server" style="width: 80%;">
        ...
        <div style="text-align: center;">
            <div class="jumbotron" style="border-radius:20px;">
                ...
                <!--linq para que liste los permisos de solo su unidad -->
                        <p align="center">Listar Permisos</p>
                        <br />
                        <!--listar codigos de permiso obtenidos de la bd-->
                        <asp:GridView ID="gvListarPermisos" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
                        ...
                        <table align="center">
                            <tr>
                                <th>
                                    <asp:Label ID="Label1" runat="server" Text="Ingrese el Numero del permiso"></asp:Label>
                                </th>
                            </tr>
                            <tr>
                                <th>
                                    <p align="center">
                                        <asp:TextBox ID="txtIdPermiso" runat="server" Width="62px"></asp:TextBox>
                                    </p>
