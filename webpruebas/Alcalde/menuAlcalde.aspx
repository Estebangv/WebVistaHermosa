<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuAlcalde.aspx.cs" Inherits="webpruebas.menuAlcalde" %>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-success">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <form class="form-inline mt-2 mt-md-0">
                <kbd><asp:Label ID="lblUserName" runat="server" CssClass=""></asp:Label></kbd>
                &nbsp&nbsp
                ...
                <table align="center">
                            <th>
                                <ul>
                                    ...
                                    <li>
                                        <a href="generarResoluciones.aspx">Generacion de Resoluciones</a>
                                    </li>
                             </ul>
                   </th>
                </table>
