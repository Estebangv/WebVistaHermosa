<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consultarPermisos.aspx.cs" Inherits="webpruebas.Alcalde.consultarPermisos" %>
...
<head runat="server">
    ...
    <title>Consultar Permmisos</title>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="menuFuncionario.aspx">Menu Funcionario <span class="sr-only">(current)</span></a>
                </li>
            </ul>
