<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="generarResoluciones.aspx.cs" Inherits="webpruebas.Alcalde.generarResoluciones" %>
    ...
    <form id="form1" runat="server" style="width: 80%;">
        ...
        <div style="text-align: center;">
            <div class="jumbotron" style="border-radius:20px;">
                <!--Cuerpo -->
                <asp:GridView ID="GvResol" runat="server"></asp:GridView>
                <p align="center"><asp:TextBox ID="txtRelCod" runat="server"></asp:TextBox></p>
                <p align="center">
                            <asp:Button ID="btnGenReso" runat="server" Text="Generar Resolucion" OnClick="btnGenerar_Click" /></p>
